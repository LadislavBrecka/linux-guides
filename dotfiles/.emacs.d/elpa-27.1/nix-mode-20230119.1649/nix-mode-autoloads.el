...
;;; Generated autoloads from nix-format.el
 (autoload 'nixfmt-buffer "nix-format")
 (autoload 'nixfmt-region "nix-format")
 (autoload 'nixfmt-on-save-mode "nix-format")

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "nix-format" '("nix-nixfmt-bin")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "nix-log" '("nix-log-path")))
